                  ...
                  >
                    <div className={style.messageBox}>
                      ...
                      <div
                        className={` ${
                          !isPicture
                            ? !isForReceiver && (isTextMessage || isFileMessage)
                              ? `${style.textBoxSender} text-white`
                              : `${style.textBoxReceiver}`
                            : ""
                        }`}
                      >
                        {msg.contentType === "picture" ? (
                          ...
                          <a
                            className={`${!isForReceiver}`}
                            href={`${apiUrl}${msg.messageContent}`}
                            download
                          >
                            {extractFilename(msg.messageContent)}{" "}
                            {/* Use extractFilename to get the filename */}
                          </a>
                        ) : (
